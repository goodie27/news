const fetchUsers = () => {
  axios
    .get(
      "http://newsapi.org/v2/top-headlines?country=ng&category=business&apiKey=29ed0cd962944169bb89b29fa6126349"
    )
    .then(response => {
      ...
      for (let i = 0; i < headline.length; i++) {
        ...
        const title = `
         ...
         <div class="img-style" style="width:364px; height: 224px;">
              <img src="${headline[i].urlToImage}" class="card-img-top" alt="...">
              <div class="card-body"> 
